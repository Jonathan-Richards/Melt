...
int loops = 200; //note that indexMode=2 will finish either at maxLoops or when it is fully sorted, whichever is first
int speed = 40; //half the number of frames for 1 full cycle (higher is a slower animation)
int delay = 10; //delay between each frame of the gif

int maxBright = 300; //starting sorting level for brightMode=0 (higher = less sorting)
int minBright = 0; //ending sorting level for brightMode=0
